...
import {StudentRulesData} from "../data/rules";

const StudentHousing = () => {
  return (
    <div className="container mx-auto py-10">
      <p className="text">{StudentRulesData.intro}</p>

      {/* Rules Section */}
   {StudentRulesData.sections?.map((section, idx) => (
...
<div className="mt-10">
  ...
  <table className="w-full border border-gray-300">
    ...
    <tbody>
      {StudentRulesData.fines?.map((fine, idx) => (
